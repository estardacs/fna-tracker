...
export default function RecentActivity({ events }: { events: Event[] }) {
  ...
  return (
    <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800 h-[400px] md:h-[600px] flex flex-col">
...
function FilterButton({ active, onClick, icon, label }: any) {
  return (
    <button
      onClick={onClick}
      className={clsx(
        "flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-md text-[10px] font-medium transition-colors cursor-pointer",
        active
